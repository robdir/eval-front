...
1. List all 'batches' of classes or students
2. List all students belonging to a class, with related data
3. 'Randomly' select a student from the selected class
4. Store an evaluation of the student for the current date (red/orange/green)
5. Only be accessed by a user with administrator privileges. 
